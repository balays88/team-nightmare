...
1.  **Phase 1: Pre-Mortem (Morticia)**
    - Execute: `{project-root}/sidecars/threat-modeling/workflows/pre-mortem.md`
    - Goal: Identify fatal design flaws.
2.  **Phase 2: Secure Design (Moody)**
    - Execute: `{project-root}/sidecars/security-architect/workflows/secure-design.md`
...
4.  **Phase 4: Compliance Audit (Barnaby)**
    - Execute: `{project-root}/sidecars/security-auditor/workflows/audit-scan.md`
    - Goal: Verify implementation against safety rules.
5.  **Phase 5: PenTest (Sherlock)**
    - Execute: `{project-root}/sidecars/penetration-tester/workflows/attack-sim.md`
